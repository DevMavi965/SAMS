...
class FacLeaveAcceptanceRecord extends StatelessWidget {
  final int approved,pending,rejected;
  const FacLeaveAcceptanceRecord({super.key, required this.approved, required this.pending, required this.rejected});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Pending",textAlign: TextAlign.center,style: TextStyle(color: Colors.grey),)
                ],
              ),
            ),
          ),
