...
class Admin_profile_Card extends StatefulWidget {
  final Admin admin;
  const Admin_profile_Card({super.key, required this.admin});

  @override
  State<Admin_profile_Card> createState() => _Admin_profile_CardState();
}

class _Admin_profile_CardState extends State<Admin_profile_Card> {
            ...
            children: [
              Container(
                ...
                child: CircleAvatar(
                  ...
                  child: Text(getLogo(widget.admin.name),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
                ),
              ),
              SizedBox(width: 20,),
              Column(
          ...
          Row(
            children: [
              OutlinedButton(
                  ...
                  }, child: Text(widget.admin.role,style: TextStyle(fontSize: 11,color: Colors.white),)),
              SizedBox(width: 20,),
              OutlinedButton(
                  style: ButtonStyle(
                  ...
                  }, child: Text(widget.admin.status,style: TextStyle(fontSize: 11,color: Colors.white),))
            ],
          )
        ],
      ),
