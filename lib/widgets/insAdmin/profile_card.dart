...
class _InsAdmin_ProfileCardState extends State<InsAdmin_ProfileCard> {
            ...
            children: [
              Container(
                ...
                child: CircleAvatar(
                  ...
                  child: Text(getLogo(widget.insAdmin.name),style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
                ),
              ),
              SizedBox(width: 20,),
              Column(
