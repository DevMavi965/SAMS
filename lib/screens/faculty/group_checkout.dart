...
class GroupCheckOutFace extends StatefulWidget {
  final List<Student> students;
  final LectureModel lecture;
  const GroupCheckOutFace({super.key, required this.students, required this.lecture});
  @override
  State<GroupCheckOutFace> createState() => _GroupCheckOutFaceState();
}
...
class _GroupCheckOutFaceState extends State<GroupCheckOutFace> {
        ...
        actions: [
          ElevatedButton(
            ...
            onPressed: (){
              ...
              Provider.of<DbService>(context,listen: false).checkOutGroup(context,widget.lecture,matchedStudentIds,"facial");
              Navigator.pop(context);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            //   ),
            // ),
            const SizedBox(height: 10),//provider
