...
class CourseAdd extends StatefulWidget {
  ...
  const CourseAdd({super.key, required this.insAdmin, required this.institute, required this.department, required this.session, required this.semester});
                        ...
                        actions: [
                          ...
                          FilledButton(
                              ...
                              onPressed: (){
                                ...
                                Provider.of<DbService>(context,listen: false).addCourse(context, widget.insAdmin.id!, widget.institute.id!, widget.department.id!, widget.session.id!, widget.semester.id!, course1);
                                Navigator.pop(context);
                                Navigator.pop(context);
                              }, child: Text("Yes")),
