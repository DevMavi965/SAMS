...
import 'package:smas3/screens/management/Course_semester.dart';
...
class CourseSession extends StatefulWidget {
  ...
  const CourseSession({super.key, required this.department, required this.insAdmin, required this.institute});

  @override
  State<CourseSession> createState() => _CourseSessionState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("${widget.department.name} Sessions",style: TextStyle(color: Colors.white),),
        centerTitle: true,
      ),
                      ...
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder:
                              (_)=>CourseSemester(insAdmin: widget.insAdmin, institute: widget.institute, department: widget.department, session: sessions[count])));
                        },
                        child: Card(
                          color: Colors.white,
                          child:
