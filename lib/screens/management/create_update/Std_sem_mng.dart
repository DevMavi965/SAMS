...
class Std_Sem_manage extends StatefulWidget {
  final InsAdmin insAdmin;
  final Institute institute;
  final Department department;
  final Session session ;
  const Std_Sem_manage({super.key, required this.insAdmin, required this.institute, required this.department, required this.session});

  @override
  State<Std_Sem_manage> createState() => _Std_Sem_manageState();
}

class _Std_Sem_manageState extends State<Std_Sem_manage> {
            ...
            if(snapshot.connectionState==ConnectionState.waiting){
              ...
              return semesters.isEmpty?Center(child: Text("No semesters found, Add first"),): ListView.builder(
                  ...
                  itemBuilder: (_,count){
                    return InkWell(
                      onTap: (){
                     Navigator.push(context, MaterialPageRoute(builder: (_)=>StdView(
                         insAdmin: widget.insAdmin, institute: widget.institute, department: widget.department, session: widget.session, semester: semesters[count])));
                      },
                      child: Card(
                        color: Colors.white,
                        child:
