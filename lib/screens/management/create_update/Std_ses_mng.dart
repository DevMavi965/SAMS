...
import 'package:smas3/screens/management/create_update/Std_sem_mng.dart';
import 'package:smas3/screens/management/create_update/semester_ops.dart';

import '../../../models/department.dart';
import '../../../services/db_service.dart';

class Std_Sessio_manage extends StatefulWidget {
  final InsAdmin insAdmin;
  final Institute institute;
  final Department department;
  const Std_Sessio_manage({super.key, required this.department, required this.insAdmin, required this.institute});

  @override
  State<Std_Sessio_manage> createState() => _Std_Sessio_manageState();
}

class _Std_Sessio_manageState extends State<Std_Sessio_manage> {
                      ...
                      return InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder:
                              (_)=>Std_Sem_manage(insAdmin: widget.insAdmin, institute: widget.institute, department: widget.department, session: sessions[count])));
                        },
                        child: Card(
                          color: Colors.white,
                          child:
