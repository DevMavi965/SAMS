...
class FaceAttendanceScreenCheckOut extends StatefulWidget {
  final Student student;
  final LectureModel lecture;
  const FaceAttendanceScreenCheckOut({super.key, required this.student, required this.lecture});

  @override
  State<FaceAttendanceScreenCheckOut> createState() =>
      _FaceAttendanceScreenCheckOutState();
}

class _FaceAttendanceScreenCheckOutState extends State<FaceAttendanceScreenCheckOut> {
  // ============================================================
  // FIRESTORE
  // ============================================================
