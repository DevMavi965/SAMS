...
class FaceAttendanceScreenMidP extends StatefulWidget {
  final Student student;
  final LectureModel lecture;
  const FaceAttendanceScreenMidP({super.key, required this.student, required this.lecture});

  @override
  State<FaceAttendanceScreenMidP> createState() =>
      _FaceAttendanceScreenMidPState();
}

class _FaceAttendanceScreenMidPState extends State<FaceAttendanceScreenMidP> {
  // ============================================================
  // FIRESTORE
  // ============================================================
              ...
              onPressed: () async{
                if(success) {
                  await Provider.of<DbService>(context, listen: false)
                      .studentMidPoint(
                      context, widget.lecture, widget.student.id!,);
